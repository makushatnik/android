...
public class TodayWidgetIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        int weatherArtResourceId = Utils.getArtResourceForWeatherCondition(weatherId);
        String description = data.getString(INDEX_SHORT_DESC);
        double maxTemp = data.getDouble(INDEX_MAX_TEMP);
        double minTemp = data.getDouble(INDEX_MIN_TEMP);
        String formattedMaxTemperature = Utils.formatTemperature(this, maxTemp);
        String formattedMinTemperature = Utils.formatTemperature(this, minTemp);
        data.close();
